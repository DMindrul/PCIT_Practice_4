...
# Копіювання скомпільованої програми до робочої директорії контейнера використовуючи змінну аргументу APP_NAME як вихідне ім'я файлу. В контейнері ім'я файлу повинно бути 'main'
